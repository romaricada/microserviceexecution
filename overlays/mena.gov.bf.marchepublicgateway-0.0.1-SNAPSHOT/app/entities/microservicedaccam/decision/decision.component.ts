...
export class DecisionComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.decisionService
      ...
      .subscribe((res: HttpResponse<IDecision[]>) => this.paginateDecisions(res.body, res.headers));
  }
  ...
  registerChangeInDecisions() {
    this.eventSubscriber = this.eventManager.subscribe('decisionListModification', () => this.loadAll());
  }
  ...
  protected paginateDecisions(data: IDecision[], headers: HttpHeaders) {
